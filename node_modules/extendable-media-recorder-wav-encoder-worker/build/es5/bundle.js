(function (global, factory) {
  ...
  var _shiftChannelDataArrays = function shiftChannelDataArrays(channelDataArrays, numberOfSamples) {
  ...
  workerFactory.createWorker(self, {
    ...
    encode: function encode(_ref) {
      ...
      var recording = recordings.get(recordingId);
      if (timeslice !== null) {
        if (recording === undefined || computeNumberOfSamples(recording.channelDataArrays[0]) * (1e3 / recording.sampleRate) < timeslice) {
        ...
        var shiftedChannelDataArrays = _shiftChannelDataArrays(recording.channelDataArrays, Math.ceil(timeslice * (recording.sampleRate / 1e3)));
    ...
    record: function record(_ref2) {
      ...
      var encoding = encodings.get(recordingId);
      if (encoding !== undefined && computeNumberOfSamples(recording.channelDataArrays[0]) * (1e3 / sampleRate) >= encoding.timeslice) {
        var shiftedChannelDataArrays = _shiftChannelDataArrays(recording.channelDataArrays, Math.ceil(encoding.timeslice * (sampleRate / 1e3)));
